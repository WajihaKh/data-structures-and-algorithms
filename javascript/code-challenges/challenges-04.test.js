...
const setState = (arr, obj) => {
  ...
  let state = {people: peopleCopy, stuff: stuffCopy};
  return state;
};
let firstState = setState(people, stuff);
...
const newState = (arr, obj) => {
  ...
  let newStateObj = { people: peopleCopy, stuff: stuffCopy};
  return newStateObj;
};

let changedState = newState(people, stuff);
